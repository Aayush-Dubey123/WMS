...
@pytest.mark.skip(reason="Endpoint not implemented in consolidated structure - get_stock_totals method missing")
@pytest.mark.asyncio
...
@pytest.mark.skip(reason="Endpoint not implemented in consolidated structure - export_report method missing")
@pytest.mark.asyncio
