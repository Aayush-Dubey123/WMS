"""
helpers.py — Consolidated utility helpers for email sending and templating.

Merges email-related helper functions:
- send_email: Async email sending via Gmail SMTP
- Email template generators for welcome and generic notifications
"""
